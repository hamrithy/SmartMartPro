                                    ...
                                    <div class="fslider" data-arrows="false" data-lightbox="gallery">
                                        <div class="flexslider">
                                            <div class="slider-wrap">
                                                <div class="slide"><a href="<?php echo base_url('public/style_front/images/blog/full/10.jpg')?>" data-lightbox="gallery-item"><img class="image_fade" src="<?php echo base_url('public/style_front/images/blog/standard/10.jpg')?>" alt="Standard Post with Gallery"></a></div>
                                                <div class="slide"><a href="<?php echo base_url('public/style_front/images/blog/full/20.jpg')?>" data-lightbox="gallery-item"><img class="image_fade" src="<?php echo base_url('public/style_front/images/blog/standard/20.jpg')?>" alt="Standard Post with Gallery"></a></div>
                                                <div class="slide"><a href="<?php echo base_url('public/style_front/images/blog/full/21.jpg')?>" data-lightbox="gallery-item"><img class="image_fade" src="<?php echo base_url('public/style_front/images/blog/standard/21.jpg')?>" alt="Standard Post with Gallery"></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="entry clearfix">
                                ...
                                <div class="entry-image clearfix">
                                    <div class="portfolio-single-image masonry-thumbs col-6" data-big="3" data-lightbox="gallery">
                                        <a href="<?php echo base_url('public/style_front/images/blog/full/2.jpg')?>" data-lightbox="gallery-item"><img class="image_fade" src="<?php echo base_url('public/style_front/images/blog/small/2.jpg')?>" alt=""></a>
                                        <a href="<?php echo base_url('public/style_front/images/blog/full/3.jpg')?>" data-lightbox="gallery-item"><img class="image_fade" src="<?php echo base_url('public/style_front/images/blog/small/3.jpg')?>" alt=""></a>
                                        <a href="<?php echo base_url('public/style_front/images/blog/full/6-1.jpg')?>" data-lightbox="gallery-item"><img class="image_fade" src="<?php echo base_url('public/style_front/images/blog/small/6-1.jpg')?>" alt=""></a>
                                        <a href="<?php echo base_url('public/style_front/images/blog/full/6-2.jpg')?>" data-lightbox="gallery-item"><img class="image_fade" src="<?php echo base_url('public/style_front/images/blog/small/6-2.jpg')?>" alt=""></a>
                                        <a href="<?php echo base_url('public/style_front/images/blog/full/12.jpg')?>" data-lightbox="gallery-item"><img class="image_fade" src="<?php echo base_url('public/style_front/images/blog/small/12.jpg')?>" alt=""></a>
                                        <a href="<?php echo base_url('public/style_front/images/blog/full/12-1.jpg')?>" data-lightbox="gallery-item"><img class="image_fade" src="<?php echo base_url('public/style_front/images/blog/small/12-1.jpg')?>" alt=""></a>
                                        <a href="<?php echo base_url('public/style_front/images/blog/full/13.jpg')?>" data-lightbox="gallery-item"><img class="image_fade" src="<?php echo base_url('public/style_front/images/blog/small/13.jpg')?>" alt=""></a>
                                        <a href="<?php echo base_url('public/style_front/images/blog/full/18.jpg')?>" data-lightbox="gallery-item"><img class="image_fade" src="<?php echo base_url('public/style_front/images/blog/small/18.jpg')?>" alt=""></a>
                                        <a href="<?php echo base_url('public/style_front/images/blog/full/19.jpg')?>" data-lightbox="gallery-item"><img class="image_fade" src="<?php echo base_url('public/style_front/images/blog/small/19.jpg')?>" alt=""></a>
                                    </div>
                                </div>
                                <div class="entry-title">
                                    ...
                                    <div class="tab-container">
                                        ...
                                        <div class="tab-content clearfix" id="tabs-1">
                                            <div id="popular-post-list-sidebar">
                                                ...
                                                <div class="spost clearfix">
                                                    <div class="entry-image">
                                                        <a href="#" class="nobg"><img class="img-circle" src="<?php echo base_url('public/style_front/images/magazine/small/3.jpg')?>" alt=""></a>
                                                    </div>
                                                    <div class="entry-c">
                                                        <div class="entry-title">
                                                ...
                                                <div class="spost clearfix">
                                                    <div class="entry-image">
                                                        <a href="#" class="nobg"><img class="img-circle" src="<?php echo base_url('public/style_front/images/magazine/small/2.jpg')?>" alt=""></a>
                                                    </div>
                                                    <div class="entry-c">
                                                        <div class="entry-title">
                                                ...
                                                <div class="spost clearfix">
                                                    <div class="entry-image">
                                                        <a href="#" class="nobg"><img class="img-circle" src="<?php echo base_url('public/style_front/images/magazine/small/1.jpg')?>" alt=""></a>
                                                    </div>
                                                    <div class="entry-c">
                                                        <div class="entry-title">
                                        ...
                                        <div class="tab-content clearfix" id="tabs-3">
                                            <div id="recent-post-list-sidebar">
                                                ...
                                                <div class="spost clearfix">
                                                    <div class="entry-image">
                                                        <a href="#" class="nobg"><img class="img-circle" src="<?php echo base_url('public/style_front/images/icons/avatar.jpg')?>" alt=""></a>
                                                    </div>
                                                    <div class="entry-c">
                                        ...
                                        <div class="iportfolio">
                                            <div class="portfolio-image">
                                                <a href="portfolio-single.html">
                                                    <img src="<?php echo base_url('public/style_front/images/portfolio/4/1.jpg')?>" alt="Open Imagination">
                                                </a>
                                                <div class="portfolio-overlay">
                                                    <a href="<?php echo base_url('public/style_front/images/blog/full/1.jpg')?>" class="center-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
                                                </div>
                                            </div>
                                            <div class="portfolio-desc center nobottompadding">
