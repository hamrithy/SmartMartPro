				...
				<br/>				
					<div class="panel panel-danger">
							  <div class="panel-heading">
								<h3 class="panel-title" id="formtitle">Logo Settings </h3>
							  </div>
							  <div class="panel-body">
					
					
			        <?php if(!is_null($this->session->flashdata("msg"))){?>
						<div class="alert alert-<?=$this->session->flashdata("msgType")?> alert-dismissable" id="alertmsg">
					...
					<div>
						<form id="frmpost" name="frmpost" method="post" action="<?php echo site_url("admin/logo/changeLogo")?>" class="form-horizontal" role="form">
										
								<div class="form-group">
									<label class="col-sm-2 control-label">Logo Image<span class="required">*</span></label>
									<div class="col-sm-8">
										  <input type="text" class="form-control" id="txtimage" name="txtimage" value="<?php echo $this->settings->getLogo()?>"onchange="myimagechange()" required>
									</div>
									<div class="col-sm-1">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<img src="<?php echo $this->settings->getLogo()?>" class="img-responsive" id="myimagedemo"/>
									</div>
								</div>
							<div class="form-group">
